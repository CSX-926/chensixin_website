      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-blue-100 flex items-center justify-center mb-4 overflow-hidden">
                <img 
              ...
              <h3 className="font-semibold text-gray-900 mb-2 text-lg sm:text-xl">Hi, I'm CHENSIXIN</h3>
          ...
          <div className="text-center md:text-left">
            <h4 className="font-semibold text-gray-900 mb-4 text-base sm:text-lg">CSX</h4>
        ...
        <div className="border-t border-gray-100 mt-6 sm:mt-8 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm sm:text-base text-center sm:text-left">
            © 2025, CHENSIXIN (jinsaheun / chris)
          </p>
