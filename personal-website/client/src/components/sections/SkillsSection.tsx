            ...
            <div className="space-y-8">
              <motion.div variants={itemVariants}>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight">
                  Building high-performance systems with modern architecture
                </h2>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-sky-50 p-6 rounded-xl border border-blue-100">
                  ...
                  <p className="text-gray-600 mt-3 text-sm">
                    Continuously exploring emerging technologies and architectural patterns to build better, more efficient systems.
                  </p>
                </div>
              </motion.div>
            </div>
